...
class Gui(QtWidgets.QMainWindow):  # self = gui
    def __init__(self, parent=None):
        ...
        self.command_selector_seq_1 = [self.ui.command_1_1, self.ui.command_1_2,
                                       self.ui.command_1_3, self.ui.command_1_4, self.ui.command_1_5]
        self.command_selector_seq_2 = [self.ui.command_2_1, self.ui.command_2_2,
                                       self.ui.command_2_3, self.ui.command_2_4, self.ui.command_2_5]
        self.command_selector_seq_3 = [self.ui.command_3_1, self.ui.command_3_2,
                                       self.ui.command_3_3, self.ui.command_3_4, self.ui.command_3_5]
        ...
        self.output_representation = OutputRepresentation.STRING
    ...
    def connect_to_gui(self):
        ...
        self.ui.setup_string_output.triggered.connect(lambda: self.set_output_representation(OutputRepresentation.STRING))
        self.ui.setup_hex_output.triggered.connect(lambda: self.set_output_representation(OutputRepresentation.HEX_LIST))
        self.ui.setup_ascii_output.triggered.connect(lambda: self.set_output_representation(OutputRepresentation.ASCII_LIST))
    ...
    def connect(self):
        ...
        self.comm.serial_init(self.serial_setup_dialog.bytesize, self.serial_setup_dialog.parity,
                              self.serial_setup_dialog.stopbits, self.serial_setup_dialog.xon_xoff, self.serial_setup_dialog.rts_cts)
    ...
    def receive_data(self):
        self.comm.serial_read(self.output_representation)
    ...
    def set_output_representation(self, mode):
        if mode == OutputRepresentation.STRING:
            self.ui.setup_string_output.setChecked(True)
            self.ui.setup_hex_output.setChecked(False)
            self.ui.setup_ascii_output.setChecked(False)
            self.output_representation = OutputRepresentation.STRING
        elif mode == OutputRepresentation.HEX_LIST:
            self.ui.setup_string_output.setChecked(False)
            self.ui.setup_hex_output.setChecked(True)
            self.ui.setup_ascii_output.setChecked(False)
            self.output_representation = OutputRepresentation.HEX_LIST
        elif mode == OutputRepresentation.ASCII_LIST:
            self.ui.setup_string_output.setChecked(False)
            self.ui.setup_hex_output.setChecked(False)
            self.ui.setup_ascii_output.setChecked(True)
            self.output_representation = OutputRepresentation.ASCII_LIST
